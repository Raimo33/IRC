...
/*   Updated: 2024/05/28 12:41:16 by craimond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class EventHandler
{
	public:
		...
		static const struct s_replyMessage				buildReplyContent(const enum e_replyCodes code, const std::string *params = NULL, const std::string &custom_msg = "");
		...
		static const struct s_commandMessage			buildCommandContent(const std::string &prefix, const e_cmd_type cmd, const std::string *params = NULL, const std::string &custom_msg = "");
